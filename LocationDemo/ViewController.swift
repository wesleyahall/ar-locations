...
//  LocationDemo
//
//  Created by Jekil Dabhoya on 18/08/22.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    class func loadFromStoryboard() -> ViewController {
        return UIStoryboard(name: "Main", bundle: nil)
            .instantiateViewController(withIdentifier: "ARCLViewController") as! ViewController
...
//                }
    ...
    func buildDemoData() -> [LocationAnnotationNode] {
        ...
        let spaceNeedle = buildNode(latitude: 34.666642, longitude: -86.731117, altitude: 185.90, imageName: "pin")
        nodes.append(spaceNeedle)

        let empireStateBuilding = buildNode(latitude: 34.666626, longitude: -86.731275, altitude: 185.37, imageName: "pin")
        nodes.append(empireStateBuilding)

        let canaryWharf = buildNode(latitude: 34.666923, longitude: -86.731005, altitude: 185.68, imageName: "pin")
        nodes.append(canaryWharf)

        let applePark = buildViewNode(latitude: 34.666854, longitude: -86.731334, altitude: 188.81, text: "Apple Park")
        nodes.append(applePark)

        let theAlamo = buildViewNode(latitude: 34.666783, longitude: -98.4861419, altitude: 182.38, text: "The Alamo")
